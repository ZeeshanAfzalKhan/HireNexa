...
const LandingPage = () => {
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 text-gray-900 dark:text-white">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-[#34aeeb] to-[#2a8bc7] dark:from-gray-800 dark:to-gray-900">
        <div className="absolute inset-0 bg-black opacity-10 dark:opacity-20"></div>
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32 text-center">
          <h1 className="text-4xl md:text-6xl font-bold mb-6">
            Find Your Dream Job with <span className="text-yellow-300 dark:text-yellow-400">HireNexa</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              to="/signup"
              className="bg-white text-[#34aeeb] dark:text-gray-900 hover:bg-gray-100 dark:hover:bg-gray-300 px-8 py-4 rounded-lg text-lg font-semibold transition-colors duration-200 shadow-lg"
            >
              Get Started Free
            </Link>
            <Link
              to="/jobs"
              className="border-2 border-white text-white dark:text-gray-900 hover:bg-white hover:text-[#34aeeb] px-8 py-4 rounded-lg text-lg font-semibold transition-colors duration-200"
            >
              Browse Jobs
            </Link>
          </div>
      ...
      <section className="py-20 bg-gray-50 dark:bg-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white dark:bg-gray-900 p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-200">
              <div className="w-16 h-16 bg-[#34aeeb] rounded-lg flex items-center justify-center mb-6">
      ...
      {/* CTA Section */}
      <section className="py-20 bg-gradient-to-r from-[#34aeeb] to-[#2a8bc7] dark:from-gray-800 dark:to-gray-900 text-center">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
