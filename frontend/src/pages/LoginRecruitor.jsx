...
const LoginRecruitor = () => {
  ...
  const { login, loading, error, message, isAuthenticated, user } = useAuth();
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <input
                  ...
                  name="remember-me"
                  type="checkbox"
                  className="h-4 w-4 text-[#34aeeb] focus:ring-[#34aeeb] border-gray-300 dark:border-gray-600 rounded"
                />
              ...
              <div className="text-sm">
                <a href="#" className="font-medium text-[#34aeeb] hover:text-[#279ed8] transition-colors">
            ...
            <div>
              <button
                type="submit"
                disabled={loading}
                className="w-full flex items-center justify-center gap-2 py-3 px-4 bg-[#34aeeb] text-white font-semibold rounded-xl hover:bg-[#279ed8] focus:ring-4 focus:ring-blue-200 dark:focus:ring-blue-800 transition-all transform hover:scale-[1.02] disabled:opacity-60 disabled:cursor-not-allowed disabled:transform-none"
              >
                {loading ? (
                  <>
