...
const SignupPage = () => {
  ...
  const handleOAuthSignup = (provider) => {
    ...
    window.location.href = `http://localhost:3000/api/auth/${provider}?role=${role}`;
  };
              ...
              <div>
                ...
                <div className="mt-1">
                  <input
                    ...
                    className="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md placeholder-gray-400 bg-white text-gray-900 focus:outline-none focus:ring-[#34aeeb] focus:border-[#34aeeb] sm:text-sm"
                  />
                </div>
              </div>
            ...
            <div>
              ...
              <div className="mt-1">
                <select
                  ...
                  value={formData.role}
                  onChange={handleChange}
                  className="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md bg-white text-gray-900 focus:outline-none focus:ring-[#34aeeb] focus:border-[#34aeeb] sm:text-sm"
                >
