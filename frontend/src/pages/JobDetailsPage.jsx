      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-6">
            ...
            {/* Similar Jobs */}
            <div className="bg-white rounded-lg shadow p-6">
              <h3 className="text-xl font-semibold text-gray-900 mb-4">Similar Jobs</h3>
              <div className="space-y-4">
                ...
                <div className="border-b border-gray-200 pb-4">
                  ...
                  <p className="text-sm text-gray-600">TechWave</p>
                  <p className="text-sm text-gray-500">$115,000</p>
                </div>
                <div>
                  <h4 className="font-medium text-gray-900">React Developer</h4>
                  <p className="text-sm text-gray-600">NextGen Agency</p>
                  <p className="text-sm text-gray-500">$105,000</p>
                </div>
              </div>
            </div>
          </div>
